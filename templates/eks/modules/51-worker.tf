...
/*
  eks_ami_id : EKS AMI id. Must find in AWS Console.
  instance_type : EC2 instance type
  min : EC2 instance min value
  max : EC2 instance max value
  instance_type_mixed(optional) : It is for using EKS mixed cluster. Multiple EC2 instance type can be written.
*/
